...
```
cd existing_repo
git remote add origin https://gitlab.com/sustainaccount/co2onboard.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sustainaccount/co2onboard/-/settings/integrations)
